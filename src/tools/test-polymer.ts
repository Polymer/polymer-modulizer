...
// import {ConvertedDocumentFilePath} from '../url-handler';
...
//   } catch (err) {
//     console.log(
//         'Error: No checkpoint found, run `yarn run polymer:checkpoint` to
//         generate a good checkpoint to compare against.');
//     process.exit(1);
//   }
