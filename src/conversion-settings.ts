...
export interface ConversionSettings {
   ...
   *
   * - "names": import by npm package name
   *   (example) '@polymer/polymer/polymer-element.js'
   * - "paths": import by relative path
   *   (example) '../../../@polymer/polymer/polymer-element.js'
   *
   * TODO(fks) 11-06-2017: Expose as user-configurable.
   */
  readonly npmImportStyle: 'names'|'paths';
}
